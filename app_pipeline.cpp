...
#include <cassert>
namespace app {
	AppPipeline::AppPipeline(AppDevice& device, const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo info) :appDevice(device)
	{
	...
	void AppPipeline::createGraphicsPipeline(const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo& configInfo)
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE
			&& "Cannot create grapgics pipeline:: no pipelineLayout provided in configInfo");
		assert(configInfo.renderPass != VK_NULL_HANDLE
			&& "Cannot create grapgics pipeline:: no renderPass provided in configInfo");
		...
		auto bindingDescriptions = AppModel::Vertex::getBindingDescription();
		auto attributeDescriptions = AppModel::Vertex::getAttributeDescription();
	...
	void AppPipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule)
	{
		...
		{
			throw  std::runtime_error("failed perform createShaderModule()!");
		}
	}
	...
	void AppPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo, bool isWireframe)
	{
