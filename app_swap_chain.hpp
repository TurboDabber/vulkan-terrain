...
class AppSwapChain {
 public:
  ...
  AppSwapChain(AppDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<AppSwapChain> previous);
  ~AppSwapChain();
  ...
  bool compareSwapFormats(const AppSwapChain& swapChain) const {
